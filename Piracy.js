var widthPiracy = 900
var heightPiracy = 300

var svgPiracy = d3.select("#Piracy").append("svg")
            .attr("height", heightPiracy)
            .attr("width", widthPiracy)

const renderPiracy = data => {
